...
function Tickets() {
  ...
  const TIME_SLOTS = ["10:00 AM", "10:30 AM", "11:00 AM", "11:30 AM", "12:00 PM", "12:30 PM", "1:00 PM", "1:30 PM", "2:00 PM", "2:30 PM", "3:00 PM", "3:30 PM", "4:00 PM", "4:30 PM", "7:00 PM", "7:30 PM", "8:00 PM"];
    ...
    Object.entries(quantities).forEach(([id, qty]) => {
      if (qty > 0) {
        ...
        if (type) {
          ...
          for(let i=0; i<qty; i++) {
            addToCart({
              title: `Museum Admission - ${type.label}${promoSuffix}`,
